...
<header id="header">
    <?php
    NavBar::begin([
        'brandLabel' => 'Rumah Sakit Nusantara Bersinar',
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            ['label' => 'Transaksi', 'url' => ['/pembayaran']],
...
<footer id="footer" class="mt-auto py-3 bg-light">
    <div class="container">
        <div class="row text-muted">
            <div class="col-md-6 text-center text-md-start">&copy; Copyright by Didi Riwanda <?= date('Y') ?> by Yii Framework</div>
